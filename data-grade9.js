...
{id:1,level:"9",chapter:"시제",topic:"과거완료",
 stem:"빈칸에 알맞은 것은?\nAfter she ___ dinner, she watched TV.",
...
{id:2,level:"9",chapter:"시제",topic:"과거완료: 경험",
 stem:"빈칸에 알맞은 것은?\nHe ___ never traveled abroad before that trip.",
...
{id:3,level:"9",chapter:"시제",topic:"과거완료: 완료",
 stem:"빈칸에 알맞은 것은?\nBy the time I got there, the concert ___.",
...
{id:7,level:"9",chapter:"조동사",topic:"조동사+have+p.p.",
 stem:"빈칸에 알맞은 것은?\nHe cant ___ the truth.' (과거 추측 부정)",
...
{id:10,level:"9",chapter:"to부정사",topic:"to부정사의 시제",
 stem:"빈칸에 알맞은 것은?\nHe seems ___ rich when he was young.",
...
{id:14,level:"9",chapter:"관계대명사",topic:"계속적 용법",
 stem:"빈칸에 알맞은 것은?\nShe passed the exam, ___ made her parents happy.",
...
{id:15,level:"9",chapter:"관계대명사",topic:"전치사+관계대명사",
 stem:"빈칸에 알맞은 것은?\nThe person ___ whom I spoke was very kind.",
...
{id:18,level:"9",chapter:"관계부사",topic:"복합관계부사",
 stem:"빈칸에 알맞은 것은?\n___ difficult it may be, dont give up.'",
...
{id:19,level:"9",chapter:"분사",topic:"독립분사구문",
 stem:"빈칸에 알맞은 것은?\n___ considered, his plan is the best.",
...
{id:21,level:"9",chapter:"가정법",topic:"without+가정법 과거완료",
 stem:"빈칸에 알맞은 것은?\nWithout your help, I ___ failed.",
...
{id:24,level:"9",chapter:"일치와 화법",topic:"시제의 일치",
 stem:"빈칸에 알맞은 것은?\nShe told me that she ___ come the next day.",
...
{id:25,level:"9",chapter:"일치와 화법",topic:"수의 일치",
 stem:"빈칸에 알맞은 것은?\nNeither Tom nor his friends ___ coming.",
...
{id:29,level:"9",chapter:"특수구문",topic:"강조구문",
 stem:"빈칸에 알맞은 것은?\nIt was yesterday ___ I met her.",
...
{id:31,level:"9",chapter:"특수구문",topic:"도치구문",
 stem:"빈칸에 알맞은 것은?\nNot only ___ he smart, but he is also kind.",
...
{id:33,level:"9",chapter:"시제",topic:"과거완료진행형",
 stem:"빈칸에 알맞은 것은?\nShe ___ for two hours when he arrived.",
...
{id:39,level:"9",chapter:"가정법",topic:"as if 가정법",
 stem:"빈칸에 알맞은 것은?\nHe talks as if he ___ everything.",
