...
{id:1,level:"8B",chapter:"대명사",topic:"부정대명사: each, every",
 stem:"빈칸에 알맞은 것은? '___ student has a textbook.'",
...
{id:2,level:"8B",chapter:"대명사",topic:"부정대명사: some, others",
 stem:"빈칸에 알맞은 것은? 'Some students like math. ___ prefer science.'",
...
{id:3,level:"8B",chapter:"대명사",topic:"재귀대명사 관용표현",
 stem:"빈칸에 알맞은 것은? 'Help ___ to some cake.'",
...
{id:4,level:"8B",chapter:"시제",topic:"현재완료: 경험",
 stem:"빈칸에 알맞은 것은? 'I have never ___ Chinese food.'",
...
{id:5,level:"8B",chapter:"시제",topic:"현재완료: 계속",
 stem:"빈칸에 알맞은 것은? 'She has lived here ___ 2015.'",
...
{id:6,level:"8B",chapter:"시제",topic:"현재완료: 완료",
 stem:"빈칸에 알맞은 것은? 'He has already ___ his homework.'",
...
{id:8,level:"8B",chapter:"조동사",topic:"should, had better",
 stem:"빈칸에 알맞은 것은? 'You had better ___ late again.'",
...
{id:9,level:"8B",chapter:"조동사",topic:"used to",
 stem:"빈칸에 알맞은 것은? 'I ___ play soccer every day when I was young.'",
...
{id:10,level:"8B",chapter:"to부정사",topic:"형용사적 용법",
 stem:"빈칸에 알맞은 것은? 'I need a pen ___.'",
...
{id:11,level:"8B",chapter:"to부정사",topic:"too~to / enough to",
 stem:"다음 문장과 같은 의미는? 'She is so kind that she helps everyone.'",
...
{id:12,level:"8B",chapter:"동명사",topic:"동명사 관용표현",
 stem:"빈칸에 알맞은 것은? 'I look forward to ___ you.'",
...
{id:13,level:"8B",chapter:"동명사",topic:"동명사와 to부정사",
 stem:"빈칸에 알맞은 것은? 'I stopped ___ when the teacher came in.'",
...
{id:14,level:"8B",chapter:"접속사",topic:"so~that~",
 stem:"빈칸에 알맞은 것은? 'He was ___ tired that he fell asleep.'",
...
{id:15,level:"8B",chapter:"접속사",topic:"if, unless",
 stem:"빈칸에 알맞은 것은? 'I will go out ___ it rains.'",
...
{id:16,level:"8B",chapter:"접속사",topic:"though, although",
 stem:"빈칸에 알맞은 것은? '___ he is rich, he is not happy.'",
...
{id:17,level:"8B",chapter:"접속사",topic:"either A or B",
 stem:"빈칸에 알맞은 것은? 'Either you ___ he has to go.'",
...
{id:18,level:"8B",chapter:"수동태",topic:"수동태 시제",
 stem:"빈칸에 알맞은 것은? 'This bridge ___ 100 years ago.'",
...
{id:19,level:"8B",chapter:"수동태",topic:"4형식 수동태",
 stem:"다음 문장의 수동태는? 'She gave me a book.'",
...
{id:20,level:"8B",chapter:"분사",topic:"감정 분사",
 stem:"빈칸에 알맞은 것은? 'The news was ___ to everyone.'",
...
{id:21,level:"8B",chapter:"분사",topic:"분사구문: 때",
 stem:"다음 문장을 분사구문으로 바꾸면? 'When she heard the news, she cried.'",
...
{id:22,level:"8B",chapter:"수동태",topic:"조동사 수동태",
 stem:"빈칸에 알맞은 것은? 'This work must ___ by tomorrow.'",
...
{id:23,level:"9",chapter:"시제",topic:"과거완료",
 stem:"빈칸에 알맞은 것은? 'When I arrived, the train ___.'",
...
{id:24,level:"9",chapter:"시제",topic:"과거완료: 경험",
 stem:"빈칸에 알맞은 것은? 'She said she ___ never been to Europe before.'",
...
{id:25,level:"9",chapter:"시제",topic:"시간/조건 부사절 현재시제",
 stem:"빈칸에 알맞은 것은? 'When he ___ tomorrow, I'll tell him.'",
...
{id:26,level:"9",chapter:"조동사",topic:"조동사+have+p.p.",
 stem:"빈칸에 알맞은 것은? 'She must ___ the bus. She's late.'",
...
{id:27,level:"9",chapter:"to부정사",topic:"원형부정사",
 stem:"빈칸에 알맞은 것은? 'I saw her ___ the street.'",
...
{id:28,level:"9",chapter:"to부정사",topic:"to부정사의 수동태",
 stem:"빈칸에 알맞은 것은? 'She wants ___ by everyone.'",
...
{id:29,level:"9",chapter:"동명사",topic:"동명사의 의미상 주어",
 stem:"빈칸에 알맞은 것은? 'Do you mind ___ opening the window?'",
...
{id:30,level:"9",chapter:"관계대명사",topic:"계속적 용법",
 stem:"빈칸에 알맞은 것은? 'I met Tom, ___ is a doctor.'",
...
{id:31,level:"9",chapter:"관계대명사",topic:"전치사+관계대명사",
 stem:"빈칸에 알맞은 것은? 'This is the house ___ which I lived.'",
...
{id:32,level:"9",chapter:"관계대명사",topic:"복합관계대명사",
 stem:"빈칸에 알맞은 것은? '___ happens, I will support you.'",
...
{id:33,level:"9",chapter:"관계부사",topic:"관계부사와 선행사 생략",
 stem:"빈칸에 알맞은 것은? 'This is ___ I was born.'",
...
{id:34,level:"9",chapter:"분사",topic:"독립분사구문",
 stem:"빈칸에 알맞은 것은? 'The weather ___ nice, we went on a picnic.'",
...
{id:35,level:"9",chapter:"가정법",topic:"가정법 과거",
 stem:"빈칸에 알맞은 것은? 'If I ___ a bird, I could fly.'",
...
{id:36,level:"9",chapter:"가정법",topic:"가정법 과거완료",
 stem:"빈칸에 알맞은 것은? 'If I had studied harder, I ___ the exam.'",
...
{id:37,level:"9",chapter:"일치와 화법",topic:"시제의 일치",
 stem:"빈칸에 알맞은 것은? 'He said that he ___ busy.'",
...
{id:38,level:"9",chapter:"일치와 화법",topic:"평서문 화법전환",
 stem:"직접화법을 간접화법으로 바꾸면? 'She said, \"I am happy.\"'",
...
{id:39,level:"9",chapter:"특수구문",topic:"강조구문",
 stem:"빈칸에 알맞은 것은? 'It was Tom ___ broke the window.'",
...
{id:40,level:"9",chapter:"특수구문",topic:"도치구문",
 stem:"빈칸에 알맞은 것은? 'Never ___ I seen such a beautiful sunset.'",
