...
{id:1,level:"7B",chapter:"인칭대명사",topic:"인칭대명사",
 stem:"빈칸에 알맞은 것은? 'My sister and I went shopping. ___ bought a new dress.'",
...
{id:2,level:"7B",chapter:"be동사",topic:"be동사 현재형",
 stem:"빈칸에 알맞은 것은? 'The students ___ in the classroom now.'",
...
{id:3,level:"7B",chapter:"be동사",topic:"be동사 과거형",
 stem:"빈칸에 알맞은 것은? 'The weather ___ very cold yesterday.'",
...
{id:4,level:"7B",chapter:"be동사",topic:"There is/are",
 stem:"빈칸에 알맞은 것은? 'There ___ three books on the table.'",
...
{id:5,level:"7B",chapter:"일반동사",topic:"현재형",
 stem:"빈칸에 알맞은 것은? 'He always ___ his teeth before bed.'",
...
{id:9,level:"7B",chapter:"의문사",topic:"Who, What",
 stem:"빈칸에 알맞은 것은? '___ did you have for lunch?'",
...
{id:11,level:"7B",chapter:"관사",topic:"부정관사 a(n)",
 stem:"빈칸에 알맞은 것은? 'She is ___ university student.'",
...
{id:12,level:"7B",chapter:"형용사",topic:"형용사의 역할",
 stem:"빈칸에 알맞은 것은? 'The movie was ___.'",
...
{id:14,level:"7B",chapter:"시제",topic:"현재/과거/미래",
 stem:"빈칸에 알맞은 것은? 'She ___ to Japan next month.'",
...
{id:15,level:"7A",chapter:"조동사",topic:"can",
 stem:"빈칸에 알맞은 것은? 'She ___ play the violin when she was five.'",
...
{id:16,level:"7A",chapter:"조동사",topic:"must",
 stem:"빈칸에 알맞은 것은? 'You ___ drive without a license.'",
...
{id:17,level:"7A",chapter:"to부정사",topic:"명사적 용법: 주어",
 stem:"빈칸에 알맞은 것은? '___ is important for health.'",
...
{id:19,level:"7A",chapter:"to부정사",topic:"부사적 용법: 목적",
 stem:"빈칸에 알맞은 것은? 'I went to the store ___ milk.'",
...
{id:20,level:"7A",chapter:"동명사",topic:"동명사의 역할",
 stem:"빈칸에 알맞은 것은? 'She is good at ___.'",
...
{id:21,level:"7A",chapter:"접속사",topic:"and, but, or, so",
 stem:"빈칸에 알맞은 것은? 'It was raining, ___ we stayed home.'",
...
{id:22,level:"7A",chapter:"접속사",topic:"when, while",
 stem:"빈칸에 알맞은 것은? '___ I was sleeping, the phone rang.'",
...
{id:23,level:"7A",chapter:"접속사",topic:"because",
 stem:"빈칸에 알맞은 것은? 'He was late ___ the bus was delayed.'",
...
{id:24,level:"7A",chapter:"전치사",topic:"시간: in, on, at",
 stem:"빈칸에 알맞은 것은? 'We have a meeting ___ Monday morning.'",
...
{id:25,level:"7A",chapter:"전치사",topic:"장소: in, on, at",
 stem:"빈칸에 알맞은 것은? 'There is a fly ___ the ceiling.'",
...
{id:26,level:"7A",chapter:"문장 종류",topic:"감탄문",
 stem:"빈칸에 알맞은 것은? '___ a wonderful day it is!'",
...
{id:28,level:"8B",chapter:"대명사",topic:"부정대명사: one, another, the other",
 stem:"빈칸에 알맞은 것은? 'I have two dogs. One is white, and ___ is black.'",
...
{id:29,level:"8B",chapter:"시제",topic:"현재완료",
 stem:"빈칸에 알맞은 것은? 'I ___ in Seoul for 10 years.'",
...
{id:30,level:"8B",chapter:"시제",topic:"현재완료: 경험",
 stem:"빈칸에 알맞은 것은? 'Have you ever ___ to Japan?'",
...
{id:32,level:"8B",chapter:"조동사",topic:"should, had better",
 stem:"빈칸에 알맞은 것은? 'You ___ see a doctor.'",
...
{id:33,level:"8B",chapter:"to부정사",topic:"형용사적 용법",
 stem:"빈칸에 알맞은 것은? 'I have a lot of homework ___.'",
...
{id:34,level:"8B",chapter:"to부정사",topic:"too~to / enough to",
 stem:"빈칸에 알맞은 것은? 'He is too young ___ drive.'",
...
{id:35,level:"8B",chapter:"동명사",topic:"동명사와 to부정사",
 stem:"빈칸에 알맞은 것은? 'She finished ___ her report.'",
...
{id:36,level:"8B",chapter:"접속사",topic:"if, unless",
 stem:"빈칸에 알맞은 것은? '___ you study hard, you will fail.'",
...
{id:37,level:"8B",chapter:"접속사",topic:"both A and B",
 stem:"빈칸에 알맞은 것은? '___ Tom and Jerry are my friends.'",
...
{id:38,level:"8B",chapter:"수동태",topic:"능동태와 수동태",
 stem:"다음 문장의 수동태는? 'Tom broke the window.'",
...
{id:39,level:"8B",chapter:"분사",topic:"현재분사와 과거분사",
 stem:"빈칸에 알맞은 것은? 'The movie was very ___.'",
...
{id:40,level:"8B",chapter:"분사",topic:"분사구문",
 stem:"빈칸에 알맞은 것은? '___ the door, she entered the room.'",
