...
{id:10,level:"5",chapter:"There+be동사",topic:"There+be",
 stem:"빈칸에 알맞은 것은?\nThere ___ a lot of snow last winter.",
...
{id:11,level:"5",chapter:"일반동사",topic:"3인칭 단수",
 stem:"빈칸에 알맞은 것은?\nMy mom ___ breakfast every morning.",
...
{id:17,level:"6B",chapter:"진행형",topic:"과거진행형",
 stem:"빈칸에 알맞은 것은?\nWhen I came home, my brother ___ games.",
...
{id:22,level:"6B",chapter:"형용사",topic:"수와 양을 나타내는 형용사",
 stem:"빈칸에 알맞은 것은?\nThere are ___ apples in the box.",
...
{id:36,level:"6A",chapter:"의문사",topic:"when, how, why",
 stem:"빈칸에 알맞은 의문사는?\n___ did you come to school? — 'By bus.'",
...
{id:37,level:"6A",chapter:"의문사",topic:"what+명사, how+형용사",
 stem:"빈칸에 알맞은 것은?\n___ is your brother?  — 'He is 12 years old.'",
...
{id:39,level:"6A",chapter:"품사",topic:"동사, 형용사, 부사",
 stem:"다음 밑줄 친 단어의 품사는?\nHe <u>carefully</u> opened the box.",
...
{id:40,level:"6A",chapter:"품사",topic:"전치사",
 stem:"다음 밑줄 친 단어의 품사는?\nThe cat is <u>under</u> the table.",
